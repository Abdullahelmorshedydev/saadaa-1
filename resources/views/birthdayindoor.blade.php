...
<body>
    ...
    <div class="weedingpage">
        <div class="weedingimg ">
            ...
            <img class="weedingimg1 animate__animated animate__fadeInRight" src="{{asset('Logo/222.jpg')}}" alt="">
        ...
        <div class="swiper mySwiper">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <img src="{{asset('Logo/indoor birthday1.jpg')}} " class="animate__animated animate__fadeInLeft" alt="">
                    <div class="awlqa3akber">
                        <div class="awlqa3a">
                            <h3 class="awlqa3ah1 animate__animated animate__fadeInLeft">mona Zaki </h3>
                            <p class="awlqa3ap animate__animated animate__fadeInUp"> For reservations and inquiries:
                                01092055544 - 0105725511
                            </p>
                            <p class="awlqa3ap2 animate__animated animate__fadeInUp"> proffesinal event planner </p>
                        </div>
                ...
                <div class="swiper-slide">
                    <img src="{{asset('Logo/indoor birthday2.jpg')}}" alt="">

                    <div class="awlqa3akber">
                        <div class="awlqa3a">
                            <h3 class="awlqa3ah1">hossam antika </h3>
                ...
                <div class="swiper-slide">
                    <img src="{{asset('Logo/indoor birthday3.jpg')}}" alt="">
                    <div class="awlqa3akber">
                        <div class="awlqa3a">
                ...
                <div class="swiper-slide">
            <img src="{{asset('Logo/indoor birthday4.jpg')}} ">
                    <div class=" awlqa3akber">
                        <div class="awlqa3a">
                            <h3 class="awlqa3ah1">Bothina amr </h3>
