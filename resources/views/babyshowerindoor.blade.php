...
<body>
    ...
    <div class="weedingpage">
        <div class="weedingimg">
            <img class="weedingimg1  animate__animated  animate__fadeInRight" src="{{asset('Logo/baby shower logo.jpg')}}" alt="">
        </div>
        ...
        <div class="swiper mySwiper">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <img src="{{asset('Logo/baby shower1.jpg')}}" class="animate__animated  animate__fadeInLeft" alt="">
                ...
                <div class="swiper-slide">
                    <img src="{{asset('Logo/baby shpwer 2.jpg')}}" alt="">
                ...
                <div class="swiper-slide">
                    <img src="{{asset('Logo/baby shpwer 3.jpg')}}" alt="">
                    <div class="awlqa3akber">
                        <div class="awlqa3a">
                ...
                <div class="swiper-slide">
                    <img src="{{asset('Logo/baby shpwer 4.jpg')}} ">
                    <div class=" awlqa3akber">
                        <div class="awlqa3a">
